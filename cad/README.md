...
The initial public draft contains the independent mesh review tool in [`review.py`](review.py). Vehicle-specific parts will be added when their source, fit status, and release artifacts can be explained without private workspace context.
